    ...
    if (!videoKey) {
      return (
        <div className="aspect-video bg-muted rounded-lg flex flex-col items-center justify-center">
          ...
          <p className="text-muted-foreground">This lesson does not have a a video yet!</p>
        </div>
      )
    }
  ...
  return (
    <div className="flex flex-col h-full bg-background pl-6">
      ...
      <div className="space-y-3 pt-3">
        <h1 className="text-3xl font-bold tracking-light text-foreground">{data.title}</h1>
        {data.description && (
